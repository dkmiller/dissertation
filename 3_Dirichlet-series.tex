...
However, the best estimate on discrepancy is found in 
...
\]
Using the above estimate on character sums, he is able to derive 
$\D_x \ll x^{-1/4}$. This fits the results of 
