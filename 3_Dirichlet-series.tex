...
are isogenous, so in particular they have the same rank. However, the following 
table seems to show that the rank of $E$ may not easily be read off from 
$L_{\sgn}(E,1)$, unlike the Birch and Swinnerton-Dyer conjecture. 
\begin{center}
\begin{tabular}{l|ll}
$E$ 
	& $\rk E$ 
