...
is able to derive $\D_x \ll x^{-\frac 1 4}$. This fits the results of 
\cite{bucar-kedlaya-2015,rouse-thorner-2016} in the number field case, both of 
which derive estimates of the form $\D_N \ll N^{-\frac 1 4+\epsilon}$ under 
GRH + functional equation for the (non-CM) elliptic curve in question. 
