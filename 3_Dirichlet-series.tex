...
$\D_N(\bx,\mu) \ll N^{-\frac 1 2+\epsilon}$. Then for any function $f$ on 
...
\[
	\D(\btheta^x,\ST) \ll \frac 1 r + \sum_{k=1}^{2 r -1} \frac 1 k \left| \frac{1}{\pi_F(x)} \sum_{\N(\fp)\leqslant x} U_k(\btheta_\fp)\right| .
\]
