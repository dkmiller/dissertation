...
\end{equation}
is an isomorphism. In fact, $\# N = \dim\h^1(\bQ_{R\cup N},\Ad^0\bar\rho^\ast)$, and 
...
\section{Discrepancy and Riemann Hypothesis}
...
representations to the fake Satake parameters above. 
...
$\alpha\in \left(0,\frac a 1 2\right)$. 
...
that $\D_N(\bx\wr\by,\mu) = \Theta(N^{-\alpha})$. 
...
Now we obtain a ``beefed-up'' version of Theorem \ref{thm:int-flip-seq}. 
