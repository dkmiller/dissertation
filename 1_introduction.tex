...
\begin{theorem}[{\cite{rosser-schoenfeld-1976}}]
...
only if $\D(P_x) \to 0$. Recall that weak convergence simply means 
...
\ref{ch:Dirichlet-series}, while the reverse implication is a result of 
Serre \cite[Th.~4]{serre-1981}. 
...
the normalized (analytic) $L$-function. 
...
\]
The following conjecture is first made in \cite{akiyama-tanigawa-1999}.
