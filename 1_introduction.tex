...
``true'' measure $L_x = \frac{\Li(t x)}{\Li(x)}\, \dd t$. The standare approach 
to proving the prime number theorem is by showing that the Riemann 
$\zeta$-function has meromorphic continuation past $\Re = 1$. 
...
Since $\zeta(s)$ does have such a meromorphic continuation, the prime number 
theorem holds. 
