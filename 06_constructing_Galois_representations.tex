...
Given any deformation $\rho$, write $\pi_{\nr(\rho)}(x)$ for the function 
...
$h\colon \bR^+\to \bR^+$ (resp.~$b\colon \bN \to \bN$) which decrease to 
zero (resp.~increase to infinity). Then there exists a weight-$2$ deformation 
$\rho$ of $\bar\rho$, such that 
\begin{enumerate}
\item
$\pi_{\nr(\rho)}(x) \ll h(x) \pi(x)$. 
