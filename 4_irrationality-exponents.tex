...
transcendental numbers with arbitrarily large irrationality exponent. When 
$d\geqslant 1$, there are a range of measures of irrationality---we will 
consider only two. 
...
Let $\vx\in (\bR/\bZ)^d$. The sequence $(\vx,2\vx,3\vx,\dots)$ will be 
equidistributed in a subtorus of $(\bR/\bZ)^d$ whose rank is equal to the 
dimension of the $\bQ$-vector space spanned by any lifts of the $x_i$ to 
$\bR$. We are interested in the case where this sequence is equidistributed in 
the whole torus $(\bR/\bZ)^d$, so assume $x_1,\dots,x_d$ are linearly 
independent over $\bQ$ (this condition makes sense for elements of 
$(\bR/\bZ)^d$). We wish to control the discrepancy of the sequence 
$(x,2x,3x,\dots)$ with respect to the Haar measure of $(\bR/\bZ)^d$. 
