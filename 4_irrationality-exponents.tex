...
CM abelian varieties. Recall that for $E$ a non-CM elliptic curve, the 
...
Galois representation) for each irreducible representation of $\ST(A)$. In the 
...
Hypothesis, we may not immediately conclude that the Akiyama--Tanigawa 
