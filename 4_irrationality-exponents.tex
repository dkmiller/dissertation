...
are linearly independent over $\bQ$.  
...
We wish to control the discrepancy of the sequence $(x,2x,3x,\dots)$ with 
respect to the Haar measure of $(\bR/\bZ)^d$. 
...
\end{align*}
The sum converges since the exponent is less than $-\frac{1}{d-1}$, hence the 
result. 
\end{proof}
