...
of $x_p$ (hence $\frac{a_p}{2\sqrt p}-x_p$ is negative). Since the sum can 
change by at most $\frac{l\log p}{2\sqrt p}$ at each step, the partial sums are 
bounded by the maximum possible value of $\frac{l \log p}{2\sqrt p}$, namely 
$l/e$ (this is calculated via elementary calculus). 
