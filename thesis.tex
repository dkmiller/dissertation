...
$E$ has CM over $\bQ$. Call $\ST$ the measure in question. Akiyama and 
Tanigawa conjecture that in fact, the discrepancy 
\[
...
evidence and certain reasonable heuristics. When $E$ is non-CM, this implies 
the Riemann 
...
$L$-functions. We show that when $E$ has CM over $\bQ$, there is no 
...
Cornell in 2012 planning on a career in academia, but halfway through had a 
